...
import {updateArticlePromo} from "../../../features/articlePromoSlice";
import FilePondPluginImageExifOrientation from 'filepond-plugin-image-exif-orientation'
import FilePondPluginImagePreview from 'filepond-plugin-image-preview'
import 'filepond-plugin-image-preview/dist/filepond-plugin-image-preview.css'
registerPlugin(FilePondPluginImageExifOrientation, FilePondPluginImagePreview)

const EditArticlePromo=({show,handleClose,art})=> {
  const dispatch = useDispatch();
   const [articlepromo,setArticlePromo]=useState(art)
...
const handleSubmit = (e) => {
  ...
  if (form.checkValidity() === true) {
    ...
    dispatch(updateArticlePromo(articlepromo));
...
<Form.Control
type="number"
placeholder="Prix aprés promotion"
name="newprix"
...
<Form.Group as={Col} md="6">
<Form.Label>Prix  Aprés promotion</Form.Label>
<Form.Control
type="number"
placeholder="Prix"
name="prix"
...
export default EditArticlePromo
